                ...
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      luxurious apartment. Explore the rich history and beauty
                      of this iconic monument right from your window.
                    </p>
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Indulge in luxury with this stunning seaside villa. Relax
                      on pristine beaches, take a dip in the private pool, and
                      soak up the sun in this exclusive coastal retreat.
                    </p>
