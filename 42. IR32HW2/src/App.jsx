  ...
  return (
    <>
      ...
      <main className="container p-4">
        ...
        <section>
          <img
            src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aG90ZWxzfGVufDB8fDB8fHww"
            alt="Cozy Loft in the City Center"
        ...
        <section>
          <img
            src="https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aG90ZWxzfGVufDB8fDB8fHww"
            alt="Beachfront Villa"
            className="img-fluid rounded"
          />
          <h4>Beachfront Villa with Stunning Views</h4>
          <p>
            Entire villa &middot; 6 guests &middot; 3 bedroomd &middot; 3 beds
            &middot; 2 baths
          </p>
          <p>
