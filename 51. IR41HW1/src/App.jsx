...
export default function App() {
  ...
  function ToggleBackground() {
    ...
    return (
      <div>
        <button style={{background: `${background}`}} onClick={() => setBackground(background === "LightBlue" ? "Gray" : "LightBlue")}>Toggle Background</button>
      </div>
    )
  }
  ...
  function MessageShowHide() {
    ...
    return (
      <div>
        <button onClick={() => setVisibility(!visibility)}>{visibility ? "Hide Message" : "Show Message"}</button>
